...
namespace Argonauts {
namespace Tool {
class CppJSONCompiler : public AbstractCompiler
{
public:
	...
	std::string name() const override { return "cpp-json"; }
	std::string help() const override { return "Generates C++ JSON parser/serializer files"; }
