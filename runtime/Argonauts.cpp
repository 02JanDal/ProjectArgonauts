...
InvalidEnumValue::InvalidEnumValue(const std::string &actual, const std::vector<std::string> &expected)
	: Exception(std::string("Unexpected enum value '") + actual + "', expected one of: '" + StringUtil::joinStrings(expected, "', '") + "'") {}
...
InvalidObjectKey::InvalidObjectKey(const std::string &actual, const std::vector<std::string> &expected)
	: Exception(std::string("Unexpected object key '") + actual + "', expected one of: '" + StringUtil::joinStrings(expected, "', '") + "'") {}
